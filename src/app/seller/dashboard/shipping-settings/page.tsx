...
import { BotMessageSquare, LayoutDashboard, Package, ShoppingBag, BarChart3, Settings, MessageSquare, Warehouse, Truck, Bell } from "lucide-react";
      ...
      <Sidebar collapsible="icon" className="shadow-lg">
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton href="/seller/dashboard/shipping-settings" isActive tooltip="Shipping Settings">
                <Truck />
