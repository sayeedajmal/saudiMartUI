...
import { BotMessageSquare, LayoutDashboard, Package, ShoppingBag, BarChart3, Settings, Users, DollarSign, MessageSquare, FileText, Warehouse, Truck, Bell } from "lucide-react";
...
const dashboardCards = [
  ...
  { title: "Active Products", value: "78", icon: Package, change: "+2 new", href: "#", color: "text-green-500" },
  { title: "Total Sales", value: "$15,230", icon: DollarSign, change: "+8% vs last month", href: "#", color: "text-purple-500" },
  { title: "Pending Orders", value: "5", icon: ShoppingBag, change: "+1 today", href: "#", color: "text-yellow-500" },
];
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <Card className="shadow-md">
              ...
              <CardContent className="space-y-2">
                 <Button variant="ghost" className="w-full justify-start p-2 text-left hover:bg-muted rounded-md text-sm">Add New Product</Button>
                 <Button variant="ghost" className="w-full justify-start p-2 text-left hover:bg-muted rounded-md text-sm">Manage Orders</Button>
