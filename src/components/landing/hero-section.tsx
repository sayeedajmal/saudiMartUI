      ...
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <div className="text-center md:text-left">
          <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Connect & Grow Your Business with{" "}
            <span className="text-primary">SaudiMart</span>
          </h1>
          <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto md:mx-0">
            The premier B2B e-commerce platform in Saudi Arabia, empowering
            buyers and sellers to thrive in a dynamic marketplace.
          </p>
        ...
        <div className="relative h-64 md:h-96 lg:h-[500px] rounded-lg overflow-hidden shadow-2xl">
          <Image
            src={logo}
            alt="B2B Marketplace illustration"
            layout="fill"
            objectFit="cover"
            data-ai-hint="marketplace business"
